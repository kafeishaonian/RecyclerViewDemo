package com.recycleview.client.main3;
...
import com.recycleview.client.main3.widget.ItemTouchHelperAdapter;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ItemViewHolder> implements ItemTouchHelperAdapter{
    ...
    public RecyclerAdapter(List<Book> mItems, OnStartDragListener dragStartListener, EventBus eventBus) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listitem_main3, parent, false);
