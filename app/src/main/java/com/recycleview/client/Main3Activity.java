...
import com.recycleview.client.main3.Book;
import com.recycleview.client.main3.RecyclerAdapter;
import com.recycleview.client.main3.SelectEvent;
import com.recycleview.client.main3.widget.OnStartDragListener;
import com.recycleview.client.main3.widget.SimpleItemTouchHelperCallback;
...
public class Main3Activity extends FragmentActivity implements OnStartDragListener {
    ...
    public void initData(){
        ...
        adapter = new RecyclerAdapter(list, this, event);
