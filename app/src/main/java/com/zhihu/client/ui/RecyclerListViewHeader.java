 ...
 */
public class RecyclerListViewHeader extends LinearLayout {
    ...
    public RecyclerListViewHeader(Context context) {
        super(context);
        initView(context);
    }

    public RecyclerListViewHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public RecyclerListViewHeader(Context context, AttributeSet attrs, int defStyle) {
